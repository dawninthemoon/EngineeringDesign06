...
// Servo range
#define _DUTY_MIN 1600    // [20213083]서보 각도의 최솟값 설정
#define _DUTY_NEU 1820    // [20213090]서보 수평 각도 펄스 값
#define _DUTY_MAX 1880    // [20213081] 서보 각도의 최댓값

// Servo speed control
#define _SERVO_ANGLE 30.0 //[20203118] 최대 가동범위에 따른 목표 서보 회전각
#define _SERVO_SPEED 30.0 //[20203118] 서보 속도 설정
...
// PID parameters
#define _KP 0.6        //[20191979] 비례제어 값
...
myservo.writeMicroseconds(_DUTY_MIN + (_DUTY_MAX - duty_curr)); //[20213086]
  }
